...
namespace TransportTicketingNetwork.Database.Migrations
{
    ...
    [Migration("20181007131346_Journey")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Main.Models.Journey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("EndBusStopId1");

                    b.Property<DateTime>("EndTime");

                    b.Property<int>("StartBusStopId");

                    b.Property<string>("StartBusStopId1");

                    b.Property<DateTime>("StartTime");

                    b.HasKey("Id");

                    b.HasIndex("EndBusStopId1");

                    b.HasIndex("StartBusStopId1");
            ...
            modelBuilder.Entity("Modules.Main.Models.Journey", b =>
                {
                    b.HasOne("Modules.Main.Models.BusStop", "EndBusStop")
                        .WithMany()
                        .HasForeignKey("EndBusStopId1");

                    b.HasOne("Modules.Main.Models.BusStop", "StartBusStop")
                        .WithMany()
                        .HasForeignKey("StartBusStopId1");
                });
